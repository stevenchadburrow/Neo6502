...
- Dec 2023: It was time to go bigger and better, and so I developed my 'masterpiece', the "Acolyte816" <a href="https://github.com/stevenchadburrow/Acolyte816">here</a>.  It used a 65816 processor, CPLD for video generation, and a PIC16 micrcontroller for bootloading.  It did work, but was so complex that it was very hard to develop for.  Because of that, not much time was spent on it.
...
- Jan 2025: Wanting to create a handheld device of some kind, I created "Mon Catcher" using a PIC24 and a small LCD.  It was going to be a dedicated device that would act similar to Pokemon GO, using sensors to since change in direction.  It worked, but I got bored of it quickly.
